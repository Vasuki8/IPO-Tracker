            ...
            "documents": [
                {
                    ...
                    "url": "https://www.sebi.gov.in/filings/public-issues/aug-2026/example-rhp.html",
                }
            ]
        }
        self.assertTrue(mod.has_primary_landing(record))
            ...
            "documents": [
                {
                    ...
                    "url": "https://www.sebi.gov.in/filings/public-issues/sep-2026/example-prospectus.html",
                }
            ]
        }
        ...
        candidates = [
            {
                ...
                "companyKey": mod.core.canonical_company("Example Limited"),
                "url": "https://www.sebi.gov.in/filings/public-issues/aug-2026/example-rhp.html",
