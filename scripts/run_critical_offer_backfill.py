...
HTML filing landing page from ever being handed to pypdf. Parser v7 is used for
...
# Use the v7-patched base parser for full-document fallbacks too.
base.offer = parser_v7.base
