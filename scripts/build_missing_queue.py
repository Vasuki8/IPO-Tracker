...
def expected_rules(record: dict[str, Any], today: date, *, stage: str | None = None):
    ...
    # A legacy value is not considered source-complete merely because it is
    # populated. Each pending field becomes an explicit provenance gap until a
    # Final Prospectus extraction records canonical field provenance.
