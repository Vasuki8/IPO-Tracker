...
VERIFIED_P4_NSE_ISSUE_TERMS: dict[str, dict[str, Any]] = {
    ...
    "etml": _entry(
        ...
        47.367,
        1.8924,
        "NSE Emerge Emerald Tyre Manufacturers Prospectus",
        "https://nsearchives.nseindia.com/emerge/corporates/content/EmeraldTyreManufacturersLimited_PROSP.pdf",
        source_basis="NSE final Prospectus: Rs 4,736.70 lakh fresh offer plus Rs 189.24 lakh OFS",
    ),
    "nmsteel": _entry(
        ...
        41.76,
        0.0,
        "NSE Emerge NewMalayalam Steel Prospectus",
        "https://nsearchives.nseindia.com/emerge/corporates/content/NewmalayalamSteelLimited_PROSP.pdf",
        source_basis="NSE final Prospectus: Rs 4,176.00 lakh fresh issue; offer for sale not applicable",
    ),
    "rajputana": _entry(
        ...
        24.70,
        0.0,
        "NSE Rajputana Biodiesel audited IPO proceeds filing",
        "https://nsearchives.nseindia.com/corporate/ixbrl/INTEGRATED_FILING_NONINDAS_93925_26052025190829_iXBRL_WEB.html",
        source_basis="NSE audited filing: company raised Rs 24.70 crore by issuing 19,00,000 shares; full proceeds allocated to issuer objects",
    ),
    "ganeshin": _entry(
        ...
        98.5774,
        0.0,
        "NSE Emerge Ganesh Infraworld Prospectus",
        "https://nsearchives.nseindia.com/emerge/corporates/content/GaneshInfraworldLimited_PROSP.pdf",
        source_basis="NSE final Prospectus: fresh issue Rs 9,857.74 lakh; offer for sale nil",
    ),
    "purpleuted": _entry(
        ...
        32.8104,
        0.0,
        "NSE Purple United Sales audited IPO proceeds filing",
        "https://nsearchives.nseindia.com/corporate/ixbrl/INTEGRATED_FILING_NONINDAS_93544_24052025143346_iXBRL_WEB.html",
        source_basis="NSE audited filing: Rs 3,281.04 lakh gross proceeds from fresh IPO issue",
    ),
    "c2c": _entry(
        ...
        99.0694,
        0.0,
        "NSE Emerge C2C Advanced Systems Prospectus",
        "https://nsearchives.nseindia.com/emerge/corporates/content/C2CAdvancedSystemsLimited_PROSP.pdf",
        source_basis="NSE final Prospectus: Rs 9,906.94 lakh fresh issue; offer for sale nil",
    ),
    "sfml": _entry(
        ...
        50.0019,
        0.0,
        "NSE Supreme Facility Management IPO disclosures",
        [
            "https://nsearchives.nseindia.com/emerge/corporates/content/SupremeFacilityManagementLtd_DRHP.pdf",
            "https://nsearchives.nseindia.com/web/sites/default/files/inline-files/BASISOFALLOTMENT-Final_supereme.pdf",
        ],
        source_basis="NSE DRHP shows fresh issue/OFS nil; final basis fixes 65,79,200 shares at Rs 76 and Rs 5,000.19 lakh issue size",
    ),
}
