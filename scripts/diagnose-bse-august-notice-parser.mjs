...
const NOTICE_NO = "20260813-16";
const URL = "https://www.bseindices.com/AsiaIndexAPI/api/DisplayNoticecircular/w?NoticeId=" + NOTICE_NO;
const LIST_URL = "https://www.bseindices.com/AsiaIndexAPI/api/GetNoticesadvancesearch_newcomb/w";
...
const catalogRow = (catalog?.Table || []).find((row) =>
  String(row?.notice_no ?? row?.Notice_no ?? "") === NOTICE_NO
) ?? null;
