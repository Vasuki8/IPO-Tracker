...
def status(queue, validation):
    ...
    # Data correctness precedes historical expansion. Populated legacy static
    # values are represented in the queue until Final Prospectus provenance is
    # established, so they block P4 just like ordinary missing fields.
