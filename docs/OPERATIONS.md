...
Source preview saves its complete validation report before printing optional PDF excerpts. Those diagnostics convert only the first 45 pages and stop after the three excerpts that appear in the log; canonical extraction retains its 520-page cap. The review job allows 50 minutes for the existing 30-document, 30-issuer and 100-document stages, including reporting and artifact upload. Document coverage and strict validation remain unchanged.
