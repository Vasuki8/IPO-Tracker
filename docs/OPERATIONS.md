...
Final Prospectus issue composition is extracted from bounded offer clauses with page and row evidence. The parser checks fresh issue plus offer for sale against the total, and share counts against an explicitly stated final issue price. An individual selling shareholder's quantity cannot stand in for the entire offer for sale, and the price-band cap cannot value the final issue. Unsupported discounts or contradictory clauses require review.
