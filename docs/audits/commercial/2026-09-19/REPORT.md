...
Release: [PR #152](https://github.com/Vasuki8/IPO-Tracker/pull/152), commits `e766387e`/`4eb0fb50`, merged as `c39c823c715599d9a169ed2b7a773a4c3cd98482`. [Validation 35410043930](https://github.com/Vasuki8/IPO-Tracker/actions/runs/35410043930) passed all 1,293 Python regressions, generation, proposal checks and strict validation. [Pages 35410171795](https://github.com/Vasuki8/IPO-Tracker/actions/runs/35410171795) and [live release verification 35410194991](https://github.com/Vasuki8/IPO-Tracker/actions/runs/35410194991) passed. Five direct live files matched the immutable merge at 00:42Z, including the current register and inventory. [release.json](release.json) records hashes for the research merge before this documentation closeout. No public product behavior changed.
